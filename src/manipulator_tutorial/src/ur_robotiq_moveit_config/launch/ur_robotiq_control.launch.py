...
def generate_launch_description():
    ...
    os.environ["GZ_SIM_SYSTEM_PLUGIN_PATH"] = os.environ.get("GZ_SIM_SYSTEM_PLUGIN_PATH", "") + os.pathsep + "/opt/ros/jazzy/lib" + os.pathsep + "/opt/ros/jazzy/lib/gz_ros2_control"
    # Declare arguments
    declared_arguments = []
    ...
    os.environ["GZ_SIM_RESOURCE_PATH"] = os.environ.get("GZ_SIM_RESOURCE_PATH", "") + os.pathsep + os.path.join(arm_robot_sim_path, 'worlds') + os.pathsep + str(Path(arm_robot_sim_path).parent.resolve())
    ...
    spawn_entity_delayed = TimerAction(period=7.0, actions=[spawn_entity])
