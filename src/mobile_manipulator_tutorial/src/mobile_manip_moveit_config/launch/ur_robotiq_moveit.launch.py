...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value='mobile_manip_moveit_config',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'description_file',
            default_value='mobile_manip.urdf.xacro',
    ...
    base_package_name = "mobile_manip_moveit_config"
    # Manually parse URDF and SRDF to bypass MoveItConfigsBuilder symlink resolution issues
    urdf_file = os.path.join(get_package_share_directory(base_package_name), "urdf", "mobile_manip.urdf.xacro")
    doc_urdf = xacro.process_file(urdf_file)
    urdf_str = doc_urdf.toprettyxml(indent='  ')
    
    srdf_file = os.path.join(get_package_share_directory(base_package_name), "srdf", "mobile_manip.srdf.xacro")
    doc_srdf = xacro.process_file(srdf_file)
    srdf_str = doc_srdf.toprettyxml(indent='  ')

    moveit_config = (
        MoveItConfigsBuilder(robot_name="ur_robotiq", package_name=base_package_name)
    ...
    moveit_config_dict['robot_description_semantic'] = srdf_str


    moveit_py_node = Node(
        name="moveit_py",
        package="mobile_manip_moveit_config",
